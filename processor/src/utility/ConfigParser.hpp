...
private:
    ...
    map<string, string> defaults = { //DEFAULTS LIST
            ...
            make_pair("gearProcVUpper", "175"),

            make_pair("goalMinArea", "0"),
            make_pair("goalMinPerimeter", "0"),
            make_pair("goalMinWidth", "0"),
            make_pair("goalMaxWidth", "1000"),
            make_pair("goalMinHeight", "0"),
            make_pair("goalMaxHeight", "1000"),
            make_pair("goalMinSolidity", "0"),
            make_pair("goalMaxSolidity", "100"),
            make_pair("goalMinVertices", "0"),
            make_pair("goalMaxVertices", "1000000"),
            make_pair("goalMinRatio", "2"),
            make_pair("goalMaxRatio", "1000"),
